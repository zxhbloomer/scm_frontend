 ...
 * @param {*} data
 */
export function getCustomerComboListApi (query) {
  return request({
 ...
 * @param {*} data
 */
export function getListApi1 (query) {
  return request({
    url: '/api/v1/customer/pagelist',
    method: 'post',
    data: query
