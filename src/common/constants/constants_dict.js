...
const DICT_M_ENTERPRISE_TYPE_SIX = '6'
const DICT_M_ENTERPRISE_TYPE_SEVEN = '7'
...
/**  货权转移审批流 */
const DICT_B_PO_CARGO_RIGHT_TRANSFER = 'b_po_cargo_right_transfer'
/**  货权转移作废审批流 */
const DICT_B_PO_CARGO_RIGHT_TRANSFER_CANCEL = 'b_po_cargo_right_transfer_cancel'

/**  货权转移审批状态  0-待审批 1-审批中 2-执行中 3-驳回 4-作废审批中 5-已作废 6-已完成*/
const DICT_B_PO_CARGO_RIGHT_TRANSFER_STATUS = 'b_po_cargo_right_transfer_status'
const DICT_B_PO_CARGO_RIGHT_TRANSFER_STATUS_ZERO = '0'
const DICT_B_PO_CARGO_RIGHT_TRANSFER_STATUS_ONE = '1'
const DICT_B_PO_CARGO_RIGHT_TRANSFER_STATUS_TWO = '2'
const DICT_B_PO_CARGO_RIGHT_TRANSFER_STATUS_THREE = '3'
const DICT_B_PO_CARGO_RIGHT_TRANSFER_STATUS_FOUR = '4'
...
export default {
  ...
  DICT_M_ENTERPRISE_TYPE_SIX,
  DICT_M_ENTERPRISE_TYPE_SEVEN,
  ...
  /**  货权转移审批流 */
  DICT_B_PO_CARGO_RIGHT_TRANSFER,
  DICT_B_PO_CARGO_RIGHT_TRANSFER_CANCEL,
  DICT_B_PO_CARGO_RIGHT_TRANSFER_STATUS,
  DICT_B_PO_CARGO_RIGHT_TRANSFER_STATUS_ZERO,
  DICT_B_PO_CARGO_RIGHT_TRANSFER_STATUS_ONE,
  DICT_B_PO_CARGO_RIGHT_TRANSFER_STATUS_TWO,
  DICT_B_PO_CARGO_RIGHT_TRANSFER_STATUS_THREE,
  DICT_B_PO_CARGO_RIGHT_TRANSFER_STATUS_FOUR,
