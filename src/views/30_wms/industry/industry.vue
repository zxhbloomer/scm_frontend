<template>
  <div class="app-container">
    ...
    <el-button-group v-if="searchsetting.visible">
      ...
      >新增</el-button>
      <el-button
        v-permission="'P_INDUSTRY:UPDATE'"
      ...
      >修改</el-button>
      <el-button
        v-permission="'P_INDUSTRY:ENABLE'"
      ...
      >启用</el-button>
      <el-button
        v-permission="'P_INDUSTRY:DISABLE'"
      ...
      >停用</el-button>
      <el-button
        v-permission="'P_INDUSTRY:EXPORT'"
...
<script>
import { getListApi, enabledSelectionApi, disAbledSelectionApi, enableOrDisAbleApi, exportApi } from '@/api/30_wms/industry/industry'
import resizeMixin from './mixin/resizeHandlerMixin'
import Pagination from '@/components/Pagination'
import elDragDialog from '@/directive/el-drag-dialog'
import editDialog from '@/views/30_wms/industry/dialog/edit'
...
export default {
  ...
  methods: {
    ...
    getDataList () {
      if (this.meDialogStatus) {
        this.dataJson.searchForm.business_id = this.data.id
      }
