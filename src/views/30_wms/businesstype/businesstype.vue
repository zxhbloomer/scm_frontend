<template>
  <div class="app-container">
    ...
    <el-button-group v-if="searchsetting.visible">
      <el-button
        v-permission="'P_BUSINESS_TYPE:ADD'"
        type="primary"
      ...
      >新增</el-button>
      <el-button
        v-permission="'P_BUSINESS_TYPE:UPDATE'"
      ...
      >修改</el-button>
      <el-button
        v-permission="'P_BUSINESS_TYPE:ENABLE'"
      ...
      >启用</el-button>
      <el-button
        v-permission="'P_BUSINESS_TYPE:DISABLE'"
      ...
      >停用</el-button>
      <el-button
        v-permission="'P_BUSINESS_TYPE:EXPORT'"
...
<script>
import { getPageListApi, enabledSelectionApi, disAbledSelectionApi, enableOrDisAbleApi, exportApi } from '@/api/30_wms/businesstype/businesstype'
import resizeMixin from './mixin/resizeHandlerMixin'
import Pagination from '@/components/Pagination'
import elDragDialog from '@/directive/el-drag-dialog'
import editDialog from '@/views/30_wms/businesstype/dialog/edit'
