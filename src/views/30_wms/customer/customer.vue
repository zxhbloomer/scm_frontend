<template>
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="">
        <delete-type-normal v-model="dataJson.searchForm.enable" />
      </el-form-item>
    ...
    <el-button-group>
      ...
      >新增</el-button>
      <el-button
        v-permission="'P_CUSTOMER:UPDATE'"
      ...
      >修改</el-button>
      <!-- <el-button
        v-permission="'P_CUSTOMER:ENABLE'"
      ...
      >启用</el-button>
      <el-button
        v-permission="'P_CUSTOMER:DISABLE'"
      ...
      >停用</el-button> -->
      <el-button
        v-permission="'P_CUSTOMER:EXPORT'"
    ...
    >
      ...
      >
        <template v-slot="scope">
          <el-tooltip
            :content="scope.row.enable === true ? '删除状态：未删除': '删除状态：已删除' "
            placement="top"
            :open-delay="500"
          >
            <el-switch
...
<script>
import { getListApi, enableOrDisAbleApi, enabledSelectionApi, disAbledSelectionApi, exportApi } from '@/api/30_wms/customer/customer'
import resizeMixin from './mixin/resizeHandlerMixin'
import Pagination from '@/components/Pagination'
import elDragDialog from '@/directive/el-drag-dialog'
import editDialog from '@/views/30_wms/customer/dialog/edit'
...
export default {
  ...
  methods: {
    ...
    getDataList () {
      ...
      const tempData = deepCopy(this.dataJson.searchForm)
      if (tempData.enable === '0') {
        tempData.enable = '1'
      } else if (tempData.enable === '1') {
        tempData.enable = '0'
      }

      getListApi(tempData).then(response => {
