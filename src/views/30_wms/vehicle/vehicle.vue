<template>
  <div class="app-container">
    ...
    >
      <el-form-item label="">
        <el-input
          v-model.trim="dataJson.searchForm.no"
          clearable
          placeholder="车牌号"
    ...
    <el-button-group v-if="!meDialogStatus">
      ...
      >启用</el-button>
      <el-button
        v-permission="'P_VEHICLE:DISABLE'"
...
<script>
import { getListApi, enableSelectionApi } from '@/api/30_wms/vehicle/vehicle'
import resizeMixin from './mixin/resizeHandlerMixin'
import Pagination from '@/components/Pagination'
import elDragDialog from '@/directive/el-drag-dialog'
import editDialog from '@/views/30_wms/vehicle/dialog/edit'
  ...
  methods: {
    ...
    handledEnableOrDisAbleApi (row) {
      ...
      this.$confirm(_message, '确认信息', {
        ...
        // loading
        this.settings.loading = true
        enableSelectionApi(selectionJson).then((_data) => {
          this.$notify({
            title: '更新处理成功',
