        ...
        <el-descriptions-item>
          ...
          >
            <el-input
              ...
              clearable
              show-word-limit
              :maxlength="dataJson.inputSettings.maxLength.prop_name"
              placeholder="请输入商品属性"
            />
          </el-form-item>
        </el-descriptions-item>
...
<script>
import { insertApi } from '@/api/30_wms/spec/spec'
      ...
      settings: {
        ...
        rules: {
          ...
          prop_name: [
            ...
            { max: 100, message: '商品属性不能超过100个字符', trigger: 'blur' }
          ],
          spec: [
  ...
  methods: {
    init () {
      ...
      if (this.copyData) {
        ...
        // 清空编号，因为编号必须唯一
        this.dataJson.tempJson.sku_code = ''
      } else {
        // 否则使用默认空数据
