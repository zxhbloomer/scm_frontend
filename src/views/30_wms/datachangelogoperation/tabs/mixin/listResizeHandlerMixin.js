  ...
  methods: {
    ...
    setUIheight () {
      try {
        ...
        if ((document.querySelectorAll('.el-button-group')[0].offsetHeight - this.$refs['minusForm'].$el.offsetHeight) > 0) {
          rtnVal = rtnVal - (document.querySelectorAll('.el-button-group')[0].offsetHeight - this.$refs['minusForm'].$el.offsetHeight) - 10
        }
