  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column
        ...
        :sort-orders="settings.sortOrders"
        show-overflow-tooltip
        prop="consumer_c_time"
        label="创建时间"
      >
        <template v-slot="scope">
          {{ formatDateTime(scope.row.consumer_c_time) }}
        </template>
      </el-table-column>
    </el-table>
    <pagination
...
<script>
import { getPageListApi } from '@/api/10_system/lognew/logmqconsumer'
...
import editDialog from '@/views/10_system/logmqconsumer/dialog/edit'
    ...
    'dataJson.searchForm': {
      handler () {
        if (this.dataJson.searchForm.daterange === null) {
          this.dataJson.searchForm.consumer_c_time_start = null
          this.dataJson.searchForm.consumer_c_time_end = null
        }
      }
    }
  },
  ...
  methods: {
    ...
    handleSearch () {
      ...
      if (this.dataJson.searchForm.daterange !== null && this.dataJson.searchForm.daterange !== undefined && this.dataJson.searchForm.ed_dt !== '') {
        this.dataJson.searchForm.consumer_c_time_start = this.dataJson.searchForm.daterange[0]
        this.dataJson.searchForm.consumer_c_time_end = this.dataJson.searchForm.daterange[1]
      }
      // 查询
