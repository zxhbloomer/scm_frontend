<template>
  <div class="app-container">
    ...
    >
      ...
      <!--      <el-form-item>-->
      <!--        <el-input-->
      <!--          v-model.trim="dataJson.searchForm.params"-->
      <!--          clearable-->
      <!--          placeholder="参数"-->
      <!--        />-->
      <!--      </el-form-item>-->
...
import { getListApi } from '@/api/10_system/lognew/logapi'
import Pagination from '@/components/Pagination_no_count'
import elDragDialog from '@/directive/el-drag-dialog'
import deepCopy from 'deep-copy'
import permission from '@/directive/permission/index.js' // 权限判断指令
import editDialog from '@/views/10_system/logapinew/dialog/edit'
  ...
  watch: {
    'dataJson.multipleSelection': {
      ...
      handler (newVal, oldVal) {
        const screenKeys = ['operation', 'url', 'start_time', 'over_time']
