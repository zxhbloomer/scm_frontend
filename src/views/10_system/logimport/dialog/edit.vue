      ...
      >
        ...
        >
          ...
          <el-descriptions-item label="页面名称">
            ...
            {{ dataJson.tempJson.page_name }}

          </el-descriptions-item>
          <el-descriptions-item label="页面编号">

            {{ dataJson.tempJson.page_code }}

          </el-descriptions-item>
          <el-descriptions-item label="导入文件">

            <el-link
              v-show="!( dataJson.tempJson.upload_url =='')"
              :href="dataJson.tempJson.upload_url"
            >
              <i class="el-icon-view el-icon--right" />下载
            </el-link>
          ...
          <el-descriptions-item label="错误信息">
            ...
            <el-link
              v-show="!(dataJson.tempJson.error_url =='')"
              type="danger"
              :href="dataJson.tempJson.error_url"
            >
              <i class="el-icon-view el-icon--right" />下载
            </el-link>
          ...
          <el-descriptions-item label="导入json">
            <json-editor
              ref="jsonEditor"
              v-model="dataJson.tempJson.import_json"
              style="width:1170px"
            />
          </el-descriptions-item>
