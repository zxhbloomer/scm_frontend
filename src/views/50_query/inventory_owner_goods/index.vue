    ...
    >
      <el-form-item>
        <select-owner
          ...
          @onReturnData="handleOwnerReturnData"
        />
      </el-form-item>
      <el-form-item>
        <el-input
    ...
    >
      ...
      >
        <template v-slot="scope">
          {{ scope.row.qty_avaible === null?'':formatNumber(scope.row.qty_avaible,true,4) }}
        </template>
      </el-table-column>
      <el-table-column
        sortable="custom"
      ...
      >
        <template v-slot="scope">
          {{ scope.row.qty_lock === null?'':formatNumber(scope.row.qty_lock,true,4) }}
        </template>
      </el-table-column>
      <el-table-column
        sortable="custom"
...
export default {
  ...
  methods: {
    ...
    getDataList () {
      ...
      queryInventoryOwnerGoods(this.dataJson.searchForm).then(response => {
