<template>
  <div class="app-container">
    ...
    <el-button-group>
      ...
      >新增</el-button>
      <el-button
        v-permission="'P_AUTHORIZE:UPDATE'"
      ...
      >修改</el-button>
      <el-button
        v-permission="'P_AUTHORIZE:COPY_INSERT'"
      ...
      >复制新增</el-button>
      <el-button
        v-permission="'P_AUTHORIZE:EXPORT'"
    ...
    >
      ...
      >
        <template v-slot="scop">
          <el-tag
            v-for="item in scop.row.roleList"
            :key="item.key"
            class="permission_tag"
            @click.stop="handleRoleClick(item.key)"
          >
            {{ item.label }}
          </el-tag>
        </template>
...
import setRoleDialog from '@/views/20_master/authorize/dialog/setRole'
import editDialog from '@/views/20_master/authorize/dialog/edit'
