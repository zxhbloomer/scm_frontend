    ...
    <div class="edit-container">
      ...
      >
        ...
        >
          ...
          <el-descriptions-item v-if="isUpdateModel" label="曾用名称">
            <el-form-item
              prop="former_name"
              label-width="0"
            >
          ...
          <el-descriptions-item v-if="isUpdateModel">
            <div
              slot="label"
            >
              状态</div>
          ...
          insertApi(tempData)
            .then(
              _data => {
                ...
                this.$confirm('新增处理成功，请选择页面调整。', '确认信息', {
                  distinguishCancelAndClose: true,
                  confirmButtonText: '跳转到企业登记列表',
                  cancelButtonText: '关闭弹出页面'
                }).then(() => {
                  this.$emit('closeMeCancel')
