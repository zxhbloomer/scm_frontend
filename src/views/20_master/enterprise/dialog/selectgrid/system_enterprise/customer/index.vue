...
import { selectSystemEnterpriseCustomerGridDataApi } from '@/api/20_master/enterprise/enterprise'
import Pagination from '@/components/Pagination_for_dialog/index.vue'

export default {
  name: 'SelectSystemEnterpriseCustomerGridData', // 页面id，和router中的name需要一致，作为缓存
  ...
  methods: {
    ...
    getDataList () {
      ...
      this.settings.btnDisabledStatus.disabledOk = true
      selectSystemEnterpriseCustomerGridDataApi(this.dataJson.searchForm).then(response => {
