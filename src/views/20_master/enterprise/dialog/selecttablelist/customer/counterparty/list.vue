...
import {
  getCounterpartyCustomerListApi, deleteApi, exportApi, exportAllApi, importApi, getDetailApi
...
export default {
  ...
  methods: {
    ...
    getDataList () {
      ...
      getCounterpartyCustomerListApi(this.dataJson.searchForm).then(response => {
