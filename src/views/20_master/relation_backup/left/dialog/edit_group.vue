...
import { updateApi, insertApi, getDataByIdApi } from '@/api/40_business/warehouse/warehousegroup'
...
export default {
  ...
  methods: {
    ...
    init () {
      ...
      this.dataJson.tempJson.type = this.type
    ...
    getDataByIdApi () {
      // 查询逻辑
      this.settings.loading = true
      getDataByIdApi({ id: this.id }).then(response => {
        // 数据初始化
