<template>
  <div class="app-container">
    ...
    <el-button-group>
      <el-button
        v-permission="'P_BANK_ACCOUNTS:ADD'"
        type="primary"
      ...
      <el-button
        v-permission="'P_BANK_ACCOUNTS:UPDATE'"
      ...
      <el-button
        v-permission="'P_BANK_ACCOUNTS:DELETE'"
      ...
      <el-button
        ...
        v-permission="'P_BANK_ACCOUNTS:EXPORT'"
        type="primary"
        icon="el-icon-zoom-in"
        :loading="settings.loading"
        @click="handleExport"
      ...
      >导出</el-button>
      <el-button
        v-permission="'P_BANK_ACCOUNTS:BANK'"
        :disabled="!settings.btnStatus.bankView"
        type="primary"
        icon="el-icon-zoom-in"
        :loading="settings.loading"
      >银企互联设置
  ...
  data () {
    return {
      ...
      settings: {
        ...
        // loading 状态
        loading: true,
        tableHeight: 400, // 使用canvas-auto-height属性自动计算高度
        duration: 4000
      },
      // vue-tour组件
      tourOption: {
