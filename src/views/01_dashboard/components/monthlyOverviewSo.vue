<template>
  <el-card>
    <!-- 标题 -->
    <div slot="header">
      <span class="el-card-title">当月信息统计-销售</span>
      <i
    ...
    <div>
      ...
      <el-row>
        <el-col :span="5">
          <div class="stat-item">
            ...
            <div class="stat-label">预收款金额-应收（万元）</div>
          </div>
        </el-col>
        <el-col :span="5">
          <div class="stat-item">
            <div class="stat-value">9,999.99</div>
            <div class="stat-label">结算收款金额-应收（万元）</div>
          </div>
        </el-col>
        <el-col :span="5">
          <div class="stat-item">
            <div class="stat-value">9,999.99</div>
            <div class="stat-label">待收款金额（万元）</div>
          </div>
        </el-col>
        <el-col :span="5">
          <div class="stat-item">
            <div class="stat-value">9,999.99</div>
            <div class="stat-label">销售数量（吨）</div>
          </div>
        </el-col>
        <el-col :span="4">
          <div class="stat-item">
      ...
      <el-row>
        <el-col :span="5">
          <div class="stat-item">
            <div class="stat-value">9,999.99</div>
            <div class="stat-label">预收款金额-实收（万元）</div>
          </div>
        </el-col>
        <el-col :span="5">
          <div class="stat-item">
            <div class="stat-value">9,999.99</div>
            <div class="stat-label">结算收款金额-实收（万元）</div>
          </div>
        </el-col>
        <el-col :span="5">
          <div class="stat-item">
            <div class="stat-value">9,999.99</div>
            <div class="stat-label">累计收款金额（万元）</div>
          </div>
        </el-col>
        <el-col :span="5">
          <div class="stat-item">
            <div class="stat-value">9,999.99</div>
            <div class="stat-label">出库合计（吨）</div>
          </div>
        </el-col>
        <el-col :span="4">
          <div class="stat-item">
