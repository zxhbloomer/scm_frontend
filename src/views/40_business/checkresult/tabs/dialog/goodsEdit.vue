      ...
      >
        ...
        <el-row>
          <el-col :span="12">
            ...
            >
              <el-input
                v-model.trim="dataJson.tempJson.qty"
                disabled
                clearable
                show-word-limit
              />
          ...
          <el-col :span="12">
            ...
            >
              <el-input
                v-model.trim="dataJson.tempJson.qty_adjust"
...
import specDialog from '@/views/40_business/inventory/dialog/dialog'
import InputSearch from '@/components/40_input/inputSearch'

export default {
  components: { InputSearch, specDialog },
