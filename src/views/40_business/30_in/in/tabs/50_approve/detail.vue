  ...
  <div class="app-container">
    <div>
      ...
      >
        <!-- 作废信息 -->
        <el-alert
          v-if="dataJson.tempJson.status === constants_dict.DICT_B_IN_STATUS_CANCEL || dataJson.tempJson.status === constants_dict.DICT_B_IN_STATUS_CANCEL_BEING_AUDITED"
          title="作废理由"
          type="error"
          :closable="false"
        />
        ...
        >
          ...
          <el-descriptions-item label="入库时间">
            {{ formatDateTime(dataJson.tempJson.inbound_time) || '-' }}
          </el-descriptions-item>
