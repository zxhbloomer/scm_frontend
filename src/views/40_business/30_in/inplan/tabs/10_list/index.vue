<template>
  <div class="app-container">
    <FloatMenu bpm-manage-permission="P_IN_PLAN:BPM_MANAGE" />
    <!-- 状态标签页 -->
    <el-tabs
      ref="minusTabs"
...
<script>
import { getListApi, getListSumApi, getApi, delApi, finishApi, exportApi } from '@/api/40_business/30_in/inplan/inplan'
