    ...
    >
      ...
      >
        <template v-slot="scope">
          {{ scope.row.planned_amount == null?'':formatNumber(scope.row.planned_amount, true, 4) }}
        </template>
      </el-table-column>
      <el-table-column
        sortable="custom"
      ...
      >
        <template v-slot="scope">
          {{ scope.row.amount == null?'':formatNumber(scope.row.amount, true, 4) }}
        </template>
      </el-table-column>
      ...
      <el-table-column
        ...
        :auto-fit="true"
        min-width="160"
        prop="refund_amount_total"
        label="累计退回金额"
        align="left"
      >
        <template v-slot="scope">
          {{ scope.row.refund_amount_total == null?'':formatNumber(scope.row.refund_amount_total, true, 4) }}
        </template>
      </el-table-column>
      ...
      >
        <template v-slot="scope">
          {{ scope.row.cancel_amount == null?'':formatNumber(scope.row.cancel_amount, true, 4) }}
        </template>
      </el-table-column>
      ...
      >
        <template v-slot="scope">
          {{ scope.row.settlement_amount == null?'':formatNumber(scope.row.settlement_amount, true, 4) }}
        </template>
      </el-table-column>
      ...
      >
        <template v-slot="scope">
          {{ scope.row.actual_amount == null?'':formatNumber(scope.row.actual_amount, true, 4) }}
        </template>
      </el-table-column>
...
import {
  getListApi
} from '@/api/40_business/fundusage/fundusage'
