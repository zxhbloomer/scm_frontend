...
export default {
  ...
  components: { previewCard, editInDialog, editOutDialog, getTrackDialog, basicEdit, inCancelConfirmDialog, outCancelConfirmDialog, ValidateLog, TrackLog, SalesReturnLog },
