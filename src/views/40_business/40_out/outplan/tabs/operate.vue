  ...
  <div class="app-container">
    ...
    >
      ...
      <bpm-dialog
        ...
        :data="popSettingsData.sponsorDialog.data"
        @closeMeCancel="closeSponsorCancel"
      />
    </div>
  </div></template>
...
export default {
  ...
  components: { BpmDialog, SelectWarehouse, SimpleUploadMutilFile, previewCard, locationDialog, binDialog, numeric, unitCalculatorDialog },
  // mixins: [mixin],
  props: {
    visible: {
      type: Boolean,
