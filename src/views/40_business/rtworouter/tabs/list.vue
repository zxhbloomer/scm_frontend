<template>
  <div class="app-container">
    ...
    <el-button-group v-if="!meDialogStatus">
      ...
      <el-button
        v-permission="'P_RT_WO_ROUTER:UPDATE'"
      ...
      >编辑</el-button>
      <el-button
        v-permission="'P_RT_WO_ROUTER:ENABLE'"
      ...
      >启用</el-button>
      <el-button
        v-permission="'P_RT_WO_ROUTER:DISABLE'"
      ...
      >禁用</el-button>
      <el-button
        v-permission="'P_RT_WO_ROUTER:INFO'"
        :disabled="!settings.btnStatus.showUpdate"
        type="primary"
        icon="el-icon-zoom-in"
        :loading="settings.loading"
...
import { getPageListApi, enableApi, disabledApi } from '@/api/40_business/rtworouter/rtworouter'
