          ...
          <el-descriptions-item>
            ...
            >
              <el-input
                ...
                :placeholder="isPlaceholderShow('请输入简称')"
                :disabled="isViewModel"
              />
            </el-form-item>
          </el-descriptions-item>
          <el-descriptions-item>
            ...
            >
              <select-dict
                ...
                :para="CONSTANTS.DICT_B_WAREHOUSE_GROUP"
                init-placeholder="请选择类型"
                :disabled="isViewModel"
              />
            </el-form-item> -->
          </el-descriptions-item>
...
import { updateApi, insertApi } from '@/api/40_business/warehouse/warehousegroup'
...
export default {
  ...
  methods: {
    ...
    initUpdateModel () {
      ...
      this.popSettingsData.searchDialogDataOne.selectedDataJson.name = this.dataJson.tempJson.business_name
      // 设置按钮
    ...
    doUpdate () {
      this.$refs['dataSubmitForm'].validate(valid => {
        if (valid) {
          const tempData = deepCopy(this.dataJson.tempJson)
          if (!this.popSettingsData.searchDialogDataOne.selectedDataJson.id) {
