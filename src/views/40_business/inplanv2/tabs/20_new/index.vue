...
import { insertApi, getApi, getOverReceiveConfigApi, validateApi } from '@/api/40_business/inplanv2/inplanv2'
import InputSearch from '@/components/40_input/inputSearch'
import orderDialog from '@/views/40_business/poorder/dialog/list/index.vue'
          ...
          insertApi(tempData)
            .then(
              _data => {
                ...
                // 通知兄弟组件，新增数据更新
                EventBus.$emit(this.EMITS.EMIT_MST_B_IN_PLAN_V2_NEW_OK, _data.data)
                this.$notify({
                  title: '新增成功',
