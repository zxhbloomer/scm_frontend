<template>
  <div class="app-container">
    ...
    <el-button-group>
      <el-button
        v-permission="'P_B_AR_REFUND:ADD'"
        type="primary"
      ...
      <el-button
        v-permission="'P_B_AR_REFUND:UPDATE'"
      ...
      <el-button
        v-permission="'P_B_AR_REFUND:DELETE'"
      ...
      <el-button
        v-permission="'P_B_AR_REFUND:CANCEL'"
      ...
      <el-button
        v-permission="'P_B_AR_REFUND:AUDIT'"
      ...
      <el-button
        v-permission="'P_B_AR_REFUND:PUSH'"
      ...
      <el-button
        ...
        v-permission="'P_B_AR_REFUND:EXPORT'"
        type="primary"
        icon="el-icon-zoom-in"
        :loading="settings.loading"
        @click="handleExport"
      ...
      >导出</el-button>
      <el-button
        v-permission="'P_B_AR_REFUND:PRINT'"
      ...
      <el-button
        v-permission="'P_B_AR_REFUND:INFO'"
