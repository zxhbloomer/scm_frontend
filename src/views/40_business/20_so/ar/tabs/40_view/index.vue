...
import bmpprocess_foot_template from '@/components/ProcessProgress/ProcessInstancePreview_foot_container.vue'
...
export default {
  components: { left_data_template, bpmprocess_body_template, bmpprocess_foot_template },
  mixins: [mixin],
  props: {
    // 业务表
    data: {
