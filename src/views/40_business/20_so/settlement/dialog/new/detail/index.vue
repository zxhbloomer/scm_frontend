  ...
  methods: {
    ...
    initDataJson () {
      ...
      if (this.data) {
        ...
        this.dataJson.tempJson.so_contract_id = this.data.so_contract_id || null
        this.dataJson.tempJson.so_order_code = this.data.so_order_code || ''
        this.dataJson.tempJson.so_order_id = this.data.so_order_id || null
