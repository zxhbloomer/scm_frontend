  ...
  <div class="app-container">
    <div>
      ...
      >
        <!-- 作废信息 -->
        <el-alert
          v-if="dataJson.tempJson.status === constants_dict.DICT_B_SO_SETTLEMENT_STATUS_FOUR || dataJson.tempJson.status === constants_dict.DICT_B_SO_SETTLEMENT_STATUS_FIVE"
          title="作废理由"
          type="error"
          :closable="false"
        />
...
import { getApi } from '@/api/40_business/20_so/settlement/settlement'
