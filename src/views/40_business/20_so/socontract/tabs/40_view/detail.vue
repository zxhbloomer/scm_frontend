<template>
  <div class="app-container">
    <div>
      ...
      >
        <el-alert
          v-if="dataJson.tempJson.status === constants_dict.DICT_B_SO_CONTRACT_STATUS_FOUR || dataJson.tempJson.status === constants_dict.DICT_B_SO_CONTRACT_STATUS_FIVE"
          title="作废理由"
          type="error"
          :closable="false"
        />
        ...
        <div>
          ...
          >
            ...
            <el-descriptions-item label="预收款金额">
              <span class="fontWeight">
                {{ dataJson.tempJson.advance_receive_price == null ? '-' : formatCurrency(dataJson.tempJson.advance_receive_price, true) }}
              </span>
            </el-descriptions-item>
            ...
            <el-descriptions-item label="未收">
              <span class="fontWeight">
                {{ dataJson.tempJson.uncollected_amount == null ? '-' : formatCurrency(dataJson.tempJson.uncollected_amount, true) }}
              </span>
            </el-descriptions-item>
