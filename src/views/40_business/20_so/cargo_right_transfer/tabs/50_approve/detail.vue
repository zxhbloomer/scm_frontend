<template>
  <div class="app-container">
    <div>
      ...
      >
        <el-alert
          v-if="dataJson.tempJson.status === constants_dict.DICT_B_SO_CARGO_RIGHT_TRANSFER_STATUS_FOUR || dataJson.tempJson.status === constants_dict.DICT_B_SO_CARGO_RIGHT_TRANSFER_STATUS_FIVE"
          title="作废理由"
          type="error"
          :closable="false"
        />
...
import { getApi } from '@/api/40_business/20_so/cargo_right_transfer/cargorighttransfer'
...
export default {
  ...
  methods: {
    ...
    getStatusTagType (status) {
      const statusMap = {
        [constants_dict.DICT_B_SO_CARGO_RIGHT_TRANSFER_STATUS_ONE]: 'info', // 草稿
        [constants_dict.DICT_B_SO_CARGO_RIGHT_TRANSFER_STATUS_TWO]: 'warning', // 审批中
        [constants_dict.DICT_B_SO_CARGO_RIGHT_TRANSFER_STATUS_THREE]: 'success', // 已完成
        [constants_dict.DICT_B_SO_CARGO_RIGHT_TRANSFER_STATUS_FOUR]: 'danger', // 已作废
        [constants_dict.DICT_B_SO_CARGO_RIGHT_TRANSFER_STATUS_FIVE]: 'danger' // 已拒绝
      }
