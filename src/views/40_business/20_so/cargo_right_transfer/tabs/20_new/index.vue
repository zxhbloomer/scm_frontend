...
import CustomerDialog from '@/views/20_master/enterprise/dialog/customer/counterparty/index.vue'
import SellerDialog from '@/views/20_master/enterprise/dialog/seller/system_enterprise/index.vue'
