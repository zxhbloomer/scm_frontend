<template>
  <div class="app-container">
      ...
      >
        ...
        <el-form-item v-if="dataJson.tabs.active === '0'">
          <select-dicts
            ...
            :para="CONSTANTS.DICT_B_SO_CARGO_RIGHT_TRANSFER_STATUS"
    ...
    <el-button-group>
      <el-button
        v-permission="'B_SO_CARGO_RIGHT_TRANSFER:ADD'"
        type="primary"
      ...
      <el-button
        v-permission="'B_SO_CARGO_RIGHT_TRANSFER:UPDATE'"
      ...
      <el-button
        v-permission="'B_SO_CARGO_RIGHT_TRANSFER:DELETE'"
      ...
      <el-button
        v-permission="'B_SO_CARGO_RIGHT_TRANSFER:CANCEL'"
      ...
      <el-button
        v-permission="'B_SO_CARGO_RIGHT_TRANSFER:AUDIT'"
      ...
      <el-button
        v-permission="'B_SO_CARGO_RIGHT_TRANSFER:FINISH'"
      ...
      <el-button
        ...
        v-permission="'B_SO_CARGO_RIGHT_TRANSFER:EXPORT'"
        type="primary"
      ...
      <!--      导出按钮 结束-->
      <el-button
        v-permission="'B_SO_CARGO_RIGHT_TRANSFER:PRINT'"
      ...
      <el-button
        v-permission="'B_SO_CARGO_RIGHT_TRANSFER:INFO'"
...
} from '@/api/40_business/20_so/cargo_right_transfer/cargorighttransfer'
...
import print_template from '@/views/40_business/20_so/cargo_right_transfer/tabs/60_print/index.vue'
  ...
  methods: {
    ...
    handleUrlParams () {
      ...
      if (orderCode) {
        ...
        this.doResetSearch()
        // 将订单编号赋值到查询条件
        this.dataJson.searchForm.so_order_code = orderCode
        // 触发查询
        this.handleSearch()
      }
    },
    ...
    handleCurrentChange (row) {
      ...
      if (this.dataJson.currentJson.id !== undefined) {
        ...
        // 审批中和驳回状态，修改按钮高亮
        if (this.dataJson.currentJson.status === constants_dict.DICT_B_SO_CARGO_RIGHT_TRANSFER_STATUS_ZERO ||
          this.dataJson.currentJson.status === constants_dict.DICT_B_SO_CARGO_RIGHT_TRANSFER_STATUS_THREE) {
        ...
        // 作废
        if (this.dataJson.currentJson.status === constants_dict.DICT_B_SO_CARGO_RIGHT_TRANSFER_STATUS_TWO) {
        ...
        // 审批
        if (this.dataJson.currentJson.status === constants_dict.DICT_B_SO_CARGO_RIGHT_TRANSFER_STATUS_ONE ||
          this.dataJson.currentJson.status === constants_dict.DICT_B_SO_CARGO_RIGHT_TRANSFER_STATUS_FOUR) {
    ...
    handleApprove () {
      ...
      _data.serial_type = constants_dict.DICT_B_SO_CARGO_RIGHT_TRANSFER
    ...
    handleDel () {
      const _data = deepCopy(this.dataJson.currentJson)
      // 状态为待审批或驳回才可以删除
      if (_data.status.toString() !== constants_type.DICT_B_SO_CARGO_RIGHT_TRANSFER_STATUS_ZERO && _data.status.toString() !== constants_type.DICT_B_SO_CARGO_RIGHT_TRANSFER_STATUS_THREE) {
    ...
    handleTabsClick (tab, event) {
      ...
      switch (tab.index) {
        case '1': // 待审批
          this.dataJson.searchForm.status_list = [constants_type.DICT_B_SO_CARGO_RIGHT_TRANSFER_STATUS_ZERO]
          break
        case '2': // 审批中
          this.dataJson.searchForm.status_list = [constants_type.DICT_B_SO_CARGO_RIGHT_TRANSFER_STATUS_ONE]
          break
        case '3': // 执行中
          this.dataJson.searchForm.status_list = [constants_type.DICT_B_SO_CARGO_RIGHT_TRANSFER_STATUS_TWO]
          break
        case '4': // 已完成
          this.dataJson.searchForm.status_list = [constants_type.DICT_B_SO_CARGO_RIGHT_TRANSFER_STATUS_SIX]
          break
        case '5': // 驳回
          this.dataJson.searchForm.status_list = [constants_type.DICT_B_SO_CARGO_RIGHT_TRANSFER_STATUS_THREE]
          break
        case '6': // 作废审批中
          this.dataJson.searchForm.status_list = [constants_type.DICT_B_SO_CARGO_RIGHT_TRANSFER_STATUS_FOUR]
          break
        case '7': // 已作废
          this.dataJson.searchForm.status_list = [constants_type.DICT_B_SO_CARGO_RIGHT_TRANSFER_STATUS_FIVE]
          break
    ...
    getApprovalStatusText (row) {
      ...
      if (row.status === constants_dict.DICT_B_SO_CARGO_RIGHT_TRANSFER_STATUS_ONE || row.status === constants_dict.DICT_B_SO_CARGO_RIGHT_TRANSFER_STATUS_FOUR) {
