        ...
        >
          ...
          <el-descriptions-item label="运输方式">
            <select-dict
              ...
              :para="CONSTANTS.DICT_B_SO_ORDER_DELIVERY_TYPE"
          ...
          <el-descriptions-item label="付款方式">
            <select-dict
              ...
              :para="CONSTANTS.DICT_B_SO_PAYMENT_TYPE"
              init-placeholder="请选择"
              style="width:100%"
            />
          </el-descriptions-item>
...
import GoodsDialog from '@/views/40_business/soorder/tabs/dialog/goodsdialog.vue'
          ...
          insertApi(tempData)
            .then(
              _data => {
                ...
                // 通知兄弟组件，新增数据更新
                EventBus.$emit(this.EMITS.EMIT_MST_SOORDER_NEW_OK, _data.data)
                this.$notify({
                  title: '新增成功',
