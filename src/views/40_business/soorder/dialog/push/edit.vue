    ...
    <div class="edit-container">
      ...
      >
        ...
        >
          ...
          <el-descriptions-item label="编号">系统自动生成</el-descriptions-item>
          ...
          <el-descriptions-item label="总采购数量（吨）">
            {{ dataJson.tempJson.order_total == null || dataJson.tempJson.order_total === '' ?'-':formatNumber(dataJson.tempJson.order_total,true,4) }}
          </el-descriptions-item>
...
import { getApi } from '@/api/40_business/pocontract/pocontract'
import { insertApi, validateApi } from '@/api/40_business/soorder/soorder'
    ...
    return {
      ...
      popSettingsData: {
        ...
        sponsorDialog: {
          ...
          form_data: {},
          // 弹出框传入参数
          serial_type: constants_dict.DICT_B_SO_ORDER,
          // 点击确定以后返回的值
          selectedDataJson: {
            id: null
          },
  ...
  methods: {
    ...
    getData () {
      ...
      getApi(this.data).then(response => {
        ...
        // 下推数据参数赋值
        this.dataJson.tempJson.so_contract_code = this.dataJson.tempJson.code
        this.dataJson.tempJson.so_contract_id = this.dataJson.tempJson.id
    ...
    handleGoodsDelete () {
      ...
      this.$confirm('是否确认删除该条数据', '确认信息', {
        ...
        this.dataJson.tempJson.order_total = 0
        ...
        this.dataJson.tempJson.detailListData.forEach(element => {
          ...
          this.dataJson.tempJson.order_total += element.qty
