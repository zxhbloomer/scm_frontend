...
import { insertApi, validateApi } from '@/api/40_business/poorder/poorder'
...
export default {
  ...
  components: { RadioDict, BpmDialog, PreviewCard, PreviewDescription, SimpleUploadMutilFile, GoodsDialog, SupplierDialog },
  mixins: [],
  props: {
    data: {
      type: Object,
  ...
  methods: {
    ...
    doInsert () {
      ...
      this.$refs['dataSubmitForm'].validate(valid => {
        if (valid) {
          ...
          tempData.po_contract_code = this.dataJson.pocontract.contract_code
          tempData.po_contract_id = this.dataJson.pocontract.id
    ...
    getData () {
      ...
      getApi(this.data).then(response => {
        ...
        this.dataJson.pocontract = deepCopy(response.data)
