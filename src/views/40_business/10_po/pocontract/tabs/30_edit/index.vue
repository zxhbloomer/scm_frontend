...
import { getApi, updateApi, validateApi } from '@/api/40_business/10_po/pocontract/pocontract'
...
export default {
  ...
  components: { RadioDict, BpmDialog, PreviewCard, PreviewDescription, SimpleUploadMutilFile, GoodsDialog, SupplierDialog, InputSearch, SelectDict },
  mixins: [],
  props: {
    data: {
      type: Object,
    ...
    return {
      ...
      popSettingsData: {
        ...
        sponsorDialog: {
          ...
          visible: false,
          form_data: { },
          serial_type: constants_bpm.BPM_B_PO_CONTRACT,
          // 点击确定以后返回的值
          selectedDataJson: {
            id: null
          },
