...
<script>
import {
  getCargoRightTransferListSumApi,
  getCargoRightTransferListApi
...
export default {
  ...
  methods: {
    ...
    getDataList () {
      ...
      getCargoRightTransferListApi(this.dataJson.searchForm).then(response => {
      ...
      // 查询合计信息
      getCargoRightTransferListSumApi(this.dataJson.searchForm).then(response => {
