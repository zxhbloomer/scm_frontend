<template>
  <div class="app-container">
    <FloatMenu bpm-manage-permission="P_AP_REFUND_PAY:BPM_MANAGE" />
    <!-- 顶部tabs页签 -->
    <el-tabs
      ref="minusTabs"
...
import {
  getListApi,
  getListSumApi
} from '@/api/40_business/10_po/aprefundpay/aprefundpay'
...
import viewDialog from '@/views/40_business/10_po/aprefundpay/dialog/view/index.vue'
...
import voucherDialog from '@/views/40_business/10_po/aprefundpay/dialog/voucher/index.vue'
