    ...
    >
      ...
      <el-form-item>
        <select-dict
          ...
          :disabled="searchDisable.serial_type"
  ...
  created () {
    ...
    if (this.meDialogStatus) {
      ...
      if (this.data && this.data.type === 'b_schedule_order') {
        if (this.data.sales_contract_code !== null && this.data.sales_contract_code !== '' && this.data.sales_contract_code !== undefined) {
          this.dataJson.searchForm.contract_no = this.data.sales_contract_code
          this.searchDisable.contract_no = true
        }
        if (this.data.sales_serial_type !== null && this.data.sales_serial_type !== '' && this.data.sales_serial_type !== undefined) {
          this.dataJson.searchForm.serial_type = this.data.sales_serial_type
          this.searchDisable.serial_type = true
        }
      }
    }
  },
