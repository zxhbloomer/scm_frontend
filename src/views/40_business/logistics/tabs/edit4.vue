...
export default {
  ...
  methods: {
    ...
    handleOrderDialog () {
      ...
      this.popSettingsData.searchDialogDataEight.data = { sales_contract_code: this.dataJson.tempJson.sales_contract_code, sales_serial_type: constants_dict.DICT_B_ORDER_OUT, type: 'b_schedule_order' }
