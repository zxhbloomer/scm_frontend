      ...
      >
        ...
        >
          ...
          <el-descriptions-item label="单据类型">
            {{ dataJson.tempJson.type_name == null?'物流订单': dataJson.tempJson.type_name }}
          </el-descriptions-item>
          ...
          <el-descriptions-item>
            ...
            >
              <input-search
                ...
                :disabled="isViewModel || settings.outPlanStatus"
...
import { updateApi1, insert1Api, getApi, getScheduleQtyApi } from '@/api/40_business/logistics/logistics'
...
import outplanDialog from '@/views/40_business/40_out/outplan/dialog/select_goods/index.vue'
...
export default {
  ...
  methods: {
    ...
    handleOrderDialog () {
      ...
      this.popSettingsData.searchDialogDataEight.data = { sales_contract_code: this.dataJson.tempJson.sales_contract_code, type: 'b_schedule_order' }
