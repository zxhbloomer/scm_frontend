...
import { updateApi, insertApi, getApi } from '@/api/40_business/in/in'
...
export default {
  components: { InputSearch, selectUnit, orderDialog, SelectDict, consignorDialog, ownerDialog, specDialog, previewCard, SimpleUploadMutilFile, numeric, unitCalculatorDialog, SelectWarehouseLocationBin },
  ...
  methods: {
    ...
    getOwnerData () {
      getOwnerComboListApi().then((_data) => {
        ...
        // 默认选中第一条
        if (constants_para.STATUS_INSERT === this.settings.dialogStatus) {
