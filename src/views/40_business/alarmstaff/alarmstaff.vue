    ...
    >
      ...
      >
        <template v-slot="column_lists">
          <el-tag
            v-for="item in column_lists.row.group_name_list"
            :key="item.id"
            class="position_tag"
          >
            {{ item.name }}
...
<script>
import { getListApi } from '@/api/40_business/alarm/alarmstaff'
import resizeMixin from './mixin/resizeHandlerMixin'
import Pagination from '@/components/Pagination'
import elDragDialog from '@/directive/el-drag-dialog'
import editDialog from '@/views/40_business/alarmstaff/dialog/edit'
