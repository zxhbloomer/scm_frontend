<template>
  <div>
      ...
      >
        ...
        <el-row>
          ...
          <el-col :span="11">
            ...
            >
              <el-input
                v-model.trim="dataJson.tempJson.login_name"
                disabled
              />
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :span="11">
            <el-form-item
              label="预警组: "
              prop="alarm_group_name"
            >
              <input-search
                v-model.trim="dataJson.tempJson.alarm_group_name"
                :disabled="isViewModel"
                @onInputSearch="handleGroup"
              />
            </el-form-item>
          </el-col>
    ...
    <group-dialog
      ...
      @closeMeCancel="handleGroupCancel"
    />
...
import { updateApi, insertApi } from '@/api/40_business/alarm/alarmstaff'

export default {
  components: { InputSearch, GroupDialog, StaffDialog },
  ...
  methods: {
    ...
    handleGroupCloseOk (val) {
      ...
      this.dataJson.tempJson.group_id = val.id
      this.dataJson.tempJson.alarm_group_name = val.name
    },
    // 预警组, 关闭对话框: 取消
    handleGroupCancel () {
