<template>
  <div>
    <el-form-item label="编辑器">
      <el-button size="small" icon="el-icon-edit" @click="visible = true">打开代码编辑器</el-button>
    </el-form-item>
    <w-dialog v-model="visible" title="编辑组件代码" @ok="ok">
      <div class="cp-preview">
        ...
        <el-button class="preview" size="mini" icon="el-icon-view" plain @click="doPreview">预览组件</el-button>
      </div>
      ...
      <el-tabs v-if="visible">
        <el-tab-pane lazy label="template">
          <code-editor v-model="config.template" lang="html" />
        </el-tab-pane>
        <el-tab-pane lazy label="script">
          <code-editor v-model="config.cpJs" lang="javascript" />
        </el-tab-pane>
        <el-tab-pane lazy label="style">
          <code-editor v-model="config.cpStyle" lang="css" />
        </el-tab-pane>
      </el-tabs>
    </w-dialog>
  </div>
