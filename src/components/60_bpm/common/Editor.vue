<template>
  <vue-editor v-model="_value" :init="init" :disabled="readonly" />
</template>
...
export default {
  ...
  props: {
    ...
    toolbar: {
      type: [String, Array],
      default: 'code undo redo restoredraft | cut copy paste pastetext | forecolor backcolor bold italic underline strikethrough link lignleft aligncenter alignright alignjustify outdent indent | bullist numlist | blockquote subscript superscript removeformat table image charmap emoticons hr pagebreak insertdatetime styleselect formatselect fontselect fontsizeselect bdmap indent2em lineheight formatpainter axupimgs | print preview | fullscreen',
      branding: false
    }
  },
  data () {
