<template>
  <div class="scm-welcome-area">
    ...
    <div class="features-section">
      ...
      <div class="features-list">
        <div class="feature-item">
          ...
          <div class="feature-text">采购流程指导</div>
        </div>
        <div class="feature-item">
          <div class="feature-icon">📦</div>
          <div class="feature-text">库存管理帮助</div>
        </div>
        <div class="feature-item">
          <div class="feature-icon">🚚</div>
          <div class="feature-text">物流操作支持</div>
        </div>
        <div class="feature-item">
          <div class="feature-icon">📊</div>
    ...
    <div class="bottom-tip">
      ...
      <span>支持输入文字描述，我会尽力帮助您解决SCM业务问题</span>
    </div>
  </div>
</template>
